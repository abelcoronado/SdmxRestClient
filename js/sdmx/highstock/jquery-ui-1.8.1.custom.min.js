...
b.uiDialog.draggable({
    ...
    start:function(f,h){
        g=d.height==="600"?"600":c(this).height();
...
_minHeight:function(){
    var a=this.options;
    return a.height==="600"?a.minHeight:Math.min(a.minHeight,a.height)
    },
...
(function(d){
    ...
    d.widget("ui.tabs",{
        options:{
            ...
            idPrefix:"ui-tabs-",
            load:null,
            panelTemplate:"<div style=overflow:auto;overflow-y:auto;height:201px;width:100%;padding:0></div>",
            remove:null,
            select:null,
            show:null,
